...
if(session_status()>=0){
   ...
   if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $sql="SELECT * From book Where time ='$time' and date ='$date' and type='Basketball'";
    ...
    if($count==1){
        ...
        header("refresh: 2; url=basketballground.php");
        exit();
    }else{
        $query="insert into book values('$uname','$umail','$address','$date','$time','Basketball')";
